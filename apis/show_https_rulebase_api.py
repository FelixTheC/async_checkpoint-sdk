...
from models.query_t_l_s_inspection_rulebase_reply import QueryTLSInspectionRulebaseReply
from models.query_t_l_s_inspection_rulebase_request import QueryTLSInspectionRulebaseRequest


async def show_https_rulebase(
    client: ClientSession, data: QueryTLSInspectionRulebaseRequest, config: Config, **kwargs
