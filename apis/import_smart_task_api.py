...
from models.import_smart_task_api_request import ImportSmartTaskApiRequest
from models.import_smart_task_reply import ImportSmartTaskReply


async def import_smart_task(
    client: ClientSession, data: ImportSmartTaskApiRequest, config: Config, **kwargs
