...
from models.export_smart_task_reply import ExportSmartTaskReply
from models.export_smart_task_api_request import ExportSmartTaskApiRequest


async def export_smart_task(
    client: ClientSession, data: ExportSmartTaskApiRequest, config: Config, **kwargs
