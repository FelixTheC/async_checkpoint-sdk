...
from models.batch_reply_task import BatchReplyTask
from models.batch_request_new import BatchRequestNew
...
async def add_objects_batch(
    ...
    BatchReplyTask
    """
    url = f"https://{config.server}:{config.port}/web_api/add-objects-batch"
    data_obj = {"body": data}
