...
from models.compliance_best_practice_request_show import ComplianceBestPracticeRequestShow
from models.compliance_show_best_practice_reply import ComplianceShowBestPracticeReply
...
async def show_best_practice(
    ...
    data : ComplianceBestPracticeRequestShow [Argument]
