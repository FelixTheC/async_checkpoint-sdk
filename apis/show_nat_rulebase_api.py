...
from models.query_nat_rulebase_reply import QueryNatRulebaseReply
from models.query_nat_rulebase_request import QueryNatRulebaseRequest


async def show_nat_rulebase(
    client: ClientSession, data: QueryNatRulebaseRequest, config: Config, **kwargs
