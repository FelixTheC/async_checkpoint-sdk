...
from models.indicator_request_new import IndicatorRequestNew


async def add_threat_indicator(
    client: ClientSession, data: IndicatorRequestNew, config: Config, **kwargs
) -> ApiTaskReply:
    """
    ...
    data : IndicatorRequestNew [Argument]
