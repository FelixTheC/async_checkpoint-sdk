...
from models.lsm_gateway_request_new import LsmGatewayRequestNew
from models.lsm_gateway_reply import LsmGatewayReply


async def add_lsm_gateway(
    client: ClientSession, data: LsmGatewayRequestNew, config: Config, **kwargs
) -> LsmGatewayReply:
    """
    Add LSM Gateway.
    ...
    data : LsmGatewayRequestNew [Argument]
