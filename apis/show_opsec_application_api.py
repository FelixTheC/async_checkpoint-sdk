...
from models.opsec_application_reply import OpsecApplicationReply
from models.api_visual_c_p_object_identifier_request_show import (
    ApiVisualCPObjectIdentifierRequestShow,
)


async def show_opsec_application(
    ...
    OpsecApplicationReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-opsec-application"
    data_obj = {"body": data}
