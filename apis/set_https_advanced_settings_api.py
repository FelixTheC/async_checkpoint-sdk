...
from models.https_advanced_settings_reply import HttpsAdvancedSettingsReply
from models.https_advanced_settings_request import HttpsAdvancedSettingsRequest


async def set_https_advanced_settings(
    client: ClientSession, data: HttpsAdvancedSettingsRequest, config: Config, **kwargs
