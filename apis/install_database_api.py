...
from models.install_db_reply import InstallDbReply
from models.install_db_request import InstallDbRequest


async def install_database(
    client: ClientSession, data: InstallDbRequest, config: Config, **kwargs
) -> InstallDbReply:
    """
