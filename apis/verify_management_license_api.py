...
from models.verify_lic_reply import VerifyLicReply
from models.verify_lic_request import VerifyLicRequest


async def verify_management_license(
    client: ClientSession, data: VerifyLicRequest, config: Config, **kwargs
) -> VerifyLicReply:
    """
