...
from models.work_session_query_request import WorkSessionQueryRequest
...
async def show_sessions(
    ...
    data : WorkSessionQueryRequest [Argument]
    ...
    ApiQueryObjectReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-sessions"
    data_obj = {"body": data}
