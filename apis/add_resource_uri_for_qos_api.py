...
from models.uri_for_qos_resource_request_new import UriForQosResourceRequestNew
from models.uri_for_qos_resource_reply import UriForQosResourceReply


async def add_resource_uri_for_qos(
    client: ClientSession, data: UriForQosResourceRequestNew, config: Config, **kwargs
