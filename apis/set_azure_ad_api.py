...
from models.azure_a_d_request_edit import AzureADRequestEdit
from models.azure_a_d_task_reply import AzureADTaskReply


async def set_azure_ad(
    client: ClientSession, data: AzureADRequestEdit, config: Config, **kwargs
) -> AzureADTaskReply:
    """
