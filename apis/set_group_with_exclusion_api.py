...
from models.group_with_exclusion_request_edit import GroupWithExclusionRequestEdit


async def set_group_with_exclusion(
    client: ClientSession, data: GroupWithExclusionRequestEdit, config: Config, **kwargs
