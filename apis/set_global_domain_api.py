...
from models.global_domain_edit_reply import GlobalDomainEditReply
from models.global_domain_request_edit import GlobalDomainRequestEdit


async def set_global_domain(
    client: ClientSession, data: GlobalDomainRequestEdit, config: Config, **kwargs
