...
from models.subscribe_object_reply import SubscribeObjectReply
from models.subscribe_object_request import SubscribeObjectRequest


async def subscribe_objects(
    client: ClientSession, data: SubscribeObjectRequest, config: Config, **kwargs
