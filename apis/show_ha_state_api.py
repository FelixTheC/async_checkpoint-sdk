...
from models.show_ha_state_reply import ShowHaStateReply
from models.show_ha_state_request import ShowHaStateRequest


async def show_ha_state(
    client: ClientSession, data: ShowHaStateRequest, config: Config, **kwargs
) -> ShowHaStateReply:
    """
