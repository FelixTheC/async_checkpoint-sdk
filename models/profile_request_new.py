...
class ProfileRequestNew(BaseModel):
    ...
    advanced_dns_settings: AdvancedDnsSettingsRequestNew = Field(
    ...
    indicator_overrides: ProfileIndicatorOverrideRequest | list[dict] = Field(
    ...
    malicious_mail_policy_settings: MailSettingsRequestNew = Field(
        alias="malicious-mail-policy-settings",
        description="""Malicious Mail Policy for MTA Gateways.""",
    )
    overrides: OverrideActivationByProtectionRequest | list[dict] = Field(
    ...
    anti_bot: bool = Field(
        alias="anti-bot", description="""Is Anti-Bot blade activated."""
    )
    anti_virus: bool = Field(
        alias="anti-virus", description="""Is Anti-Virus blade activated."""
    )
