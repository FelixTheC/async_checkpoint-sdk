...
class WorkSessionReply(BaseModel):
    name: str = Field(
    ...
    description: str = Field(
        alias="description", description="""Session description."""
    )
    ...
    in_work: bool = Field(
        alias="in-work", description="""True if the session is in work state."""
    )
    ...
    user_name: str = Field(
        alias="user-name", description="""The name of the logged in user."""
    )
    ...
    workflow_state: str = Field(
        alias="workflow-state", description="""Workflow session state."""
    )
    color: str = Field(
        alias="color",
