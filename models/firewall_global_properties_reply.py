...
class FirewallGlobalPropertiesReply(BaseModel):
    ...
    accept_ips1_management_connections_position: str = Field(
        alias="accept-ips1-management-connections-position",
        description="""The position of the implied rules in the Rule Base.""",
    )
    ...
    accept_remote_access_control_connections_position: str = Field(
        alias="accept-remote-access-control-connections-position",
        description="""The position of the implied rules in the Rule Base.""",
    )
    ...
    accept_dynamic_addr_modules_outgoing_internet_connections_position: str = Field(
        alias="accept-dynamic-addr-modules-outgoing-internet-connections-position",
        description="""The position of the implied rules in the Rule Base.<br>Available only if accept-dynamic-addr-modules-outgoing-internet-connections is true.""",
    )
    ...
    accept_incoming_traffic_to_dhcp_and_dns_services_of_gws_position: str = Field(
        alias="accept-incoming-traffic-to-dhcp-and-dns-services-of-gws-position",
        description="""The position of the implied rules in the Rule Base.<br>Available only if accept-incoming-traffic-to-dhcp-and-dns-services-of-gws is true.""",
    )
    ...
    accept_vrrp_packets_originating_from_cluster_members_position: str = Field(
        ...
        description="""The position of the implied rules in the Rule Base.<br>Available only if accept-vrrp-packets-originating-from-cluster-members is true.""",
    )
    ...
    accept_web_and_ssh_connections_for_gw_administration_position: str = Field(
        alias="accept-web-and-ssh-connections-for-gw-administration-position",
        description="""The position of the implied rules in the Rule Base.<br>Available only if accept-web-and-ssh-connections-for-gw-administration is true.""",
    )
