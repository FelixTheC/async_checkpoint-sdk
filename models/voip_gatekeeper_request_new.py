...
from voip_gatekeeper_routing_mode_request_new import VoipGatekeeperRoutingModeRequestNew


class VoipGatekeeperRequestNew(BaseModel):
    routing_mode: VoipGatekeeperRoutingModeRequestNew = Field(
        alias="routing-mode",
