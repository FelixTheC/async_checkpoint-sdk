...
class LegacyVirtualSystemReply(BaseModel):
    name: str = Field(
    ...
    hit_count: bool = Field(
        alias="hit-count", description="""Status of rule hit count for FW1."""
    )
    ...
    vs_type: str = Field(alias="vs-type", description="""N/A""")
    vsid: int = Field(alias="vsid", description="""N/A""")
    vsx_name: str = Field(alias="vsx-name", description="""N/A""")
    vsx_uid: str = Field(alias="vsx-uid", description="""N/A""")
    color: str = Field(
        alias="color",
