...
class VpnSettingsReply(BaseModel):
    ...
    advanced: VpnAdvancedReply = Field(
    ...
    link_selection: LinkSelectionReply = Field(
        alias="link-selection", description="""N/A"""
    )
    ...
    remote_access: RemoteAccessReply = Field(
        alias="remote-access", description="""N/A"""
    )
