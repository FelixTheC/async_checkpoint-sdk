...
class GatewayServerNetworkBladesReply(BaseModel):
    ...
    anti_spam: bool = Field(
        alias="anti-spam", description="""Anti-Spam & Email Security blade."""
    )
    ...
    url_filtering: bool = Field(
        alias="url-filtering", description="""URL filtering blade."""
    )
    zero_phishing: bool = Field(
        alias="zero-phishing", description="""Zero phishing blade."""
    )
