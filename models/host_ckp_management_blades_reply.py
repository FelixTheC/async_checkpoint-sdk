...
class HostCkpManagementBladesReply(BaseModel):
    ...
    secondary: bool = Field(
        alias="secondary", description="""Secondary Management enabled."""
    )
    ...
    compliance: bool = Field(
        alias="compliance", description="""Compliance blade enabled."""
    )
    user_directory: bool = Field(
        alias="user-directory", description="""User Directory enabled."""
    )
