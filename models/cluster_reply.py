...
class ClusterReply(BaseModel):
    ...
    cluster_members: list[dict] = Field(
        alias="cluster-members", description="""Cluster members."""
    )
    ...
    cluster_xl: bool = Field(
        alias="cluster-xl", description="""Cluster XL blade enabled."""
    )
    ...
    logs_settings: LogsSettingsReply = Field(
        alias="logs-settings", description="""N/A"""
    )
