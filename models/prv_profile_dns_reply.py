...
class PrvProfileDnsReply(BaseModel):
    ...
    primary_server: str = Field(
        alias="primary-server", description="""Primary DNS Server."""
    )
    secondary_server: str = Field(
        alias="secondary-server", description="""Secondary DNS Server."""
    )
...
Manual- set dns servers configuration manually.""",
    ...
    tertiary_server: str = Field(
        alias="tertiary-server", description="""Tertiary DNS Server."""
    )
