...
class ManualConfigurationSettingsRequestNew(BaseModel):
    internal_users: bool = Field(
        alias="internal-users", description="""Internal users."""
    )
    ...
    specific_directories: str | list[str] = Field(
