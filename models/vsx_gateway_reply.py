...
class VsxGatewayReply(BaseModel):
    name: str = Field(
    ...
    virtual_systems: list[dict] = Field(
        ...
        description="""Virtual Systems belonging to this VSX Gateway.""",
    )
    policy: list[dict] = Field(
        alias="policy", description="""Installed policy packages."""
    )
    color: str = Field(
        alias="color",
