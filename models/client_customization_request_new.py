...
class ClientCustomizationRequestNew(BaseModel):
    ...
    allow_mail: bool = Field(
        alias="allow-mail", description="""Enable/Disable email app."""
    )
    ...
    allow_tasks: bool = Field(
        alias="allow-tasks", description="""Enable/Disable Tasks app."""
    )
