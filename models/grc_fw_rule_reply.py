...
class GrcFwRuleReply(BaseModel):
    action: GrcFwRuleObjectReply = Field(
        alias="action", description="""User-defined actions."""
    )
    ...
    name: FwRuleConditionTypeReply = Field(
        alias="name", description="""User-defined name."""
    )
    ...
    time: GrcFwRuleObjectReply = Field(
        alias="time", description="""User-defined time."""
    )
    track: GrcFwRuleObjectReply = Field(
        alias="track", description="""User-defined track actions."""
    )
    vpn: GrcFwRuleObjectReply = Field(
        alias="vpn", description="""User-defined VPN objects."""
    )
