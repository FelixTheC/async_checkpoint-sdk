...
class VpnRemoteAccessCommunityReply(BaseModel):
    name: str = Field(
    ...
    user_groups: list[dict] = Field(
        alias="user-groups",
        description="""Collection of User group objects identified by the name or UID. Level of details in the output corresponds to the number of details for search. This table shows the level of details in the Standard level.""",
    )
