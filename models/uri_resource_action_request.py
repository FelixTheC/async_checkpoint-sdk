...
class UriResourceActionRequest(BaseModel):
    ...
    strip_ftp_links: bool = Field(
        alias="strip-ftp-links", description="""Strip ftp links."""
    )
    strip_port_strings: bool = Field(
        alias="strip-port-strings", description="""Strip ports."""
    )
