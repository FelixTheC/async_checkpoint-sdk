...
class ClusterRequestEdit(BaseModel):
    ...
    hardware: str = Field(
        alias="hardware", description="""Cluster platform hardware."""
    )
    ...
    ips_settings: IpsSettingsClusterRequestEdit = Field(
    ...
    os_name: str = Field(
        alias="os-name", description="""Cluster platform operating system."""
    )
