...
class SecurityZoneSettingsReply(BaseModel):
    ...
    auto_calculated_zone: str = Field(
        alias="auto-calculated-zone", description="""N/A"""
    )
    auto_calculated_zone_uid: str = Field(
        alias="auto-calculated-zone-uid", description="""N/A"""
    )
