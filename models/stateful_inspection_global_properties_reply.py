...
class StatefulInspectionGlobalPropertiesReply(BaseModel):
    ...
    tcp_out_of_state_drop_exceptions: list[dict] = Field(
        alias="tcp-out-of-state-drop-exceptions",
        description="""Lists the gateways and clusters for which Out of State packets are allowed.""",
    )
