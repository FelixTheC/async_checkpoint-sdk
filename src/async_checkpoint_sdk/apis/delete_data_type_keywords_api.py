...
async def delete_data_type_keywords(
    client: ClientSession, data: ApiVisualCPObjectIdentifierRequestDelete, config: SDKConfig, **kwargs
) -> ApiOkReply:
    """
    Delete existing Keywords Data Type object using object name or uid.
    ...
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-data-type-keywords"
    data_obj = {"body": data}
