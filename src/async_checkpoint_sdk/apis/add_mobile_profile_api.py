...
from async_checkpoint_sdk.models.mobile_profile_request_new import MobileProfileRequestNew
from src.async_checkpoint_sdk.sdk_config import SDKConfig


async def add_mobile_profile(
    client: ClientSession, data: MobileProfileRequestNew, config: SDKConfig, **kwargs
) -> MobileProfileReply:
    """
