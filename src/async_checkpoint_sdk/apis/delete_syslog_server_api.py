...
async def delete_syslog_server(
    ...
    ApiOkReply
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-syslog-server"
    data_obj = {"body": data}
