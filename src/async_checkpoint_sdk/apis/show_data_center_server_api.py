...
from async_checkpoint_sdk.models.data_center_server_reply import DataCenterServerReply
from src.async_checkpoint_sdk.sdk_config import SDKConfig


async def show_data_center_server(
    client: ClientSession, data: ApiVisualCPObjectIdentifierRequestShow, config: SDKConfig, **kwargs
) -> DataCenterServerReply:
    """
    Retrieve existing Data Center Server using name or uid.
    ...
    return DataCenterServerReply(**resp)
