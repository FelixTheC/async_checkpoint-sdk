...
async def delete_logical_server(
    ...
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-logical-server"
    data_obj = {"body": data}
