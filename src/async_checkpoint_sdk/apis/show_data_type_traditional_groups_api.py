...
async def show_data_type_traditional_groups(
    client: ClientSession, data: ApiQueryRequest, config: SDKConfig, **kwargs
) -> ApiQueryObjectReply:
    """
    Retrieve all Traditional Group Data Type objects.
    ...
    ApiQueryObjectReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-data-type-traditional-groups"
    data_obj = {"body": data}
