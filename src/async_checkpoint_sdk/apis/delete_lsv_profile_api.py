...
async def delete_lsv_profile(
    ...
    ApiOkReply
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-lsv-profile"
    data_obj = {"body": data}
