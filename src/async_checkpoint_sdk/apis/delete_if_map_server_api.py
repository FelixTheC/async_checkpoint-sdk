...
async def delete_if_map_server(
    ...
    ApiOkReply
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-if-map-server"
    data_obj = {"body": data}
