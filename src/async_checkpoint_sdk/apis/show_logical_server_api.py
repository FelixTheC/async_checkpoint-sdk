...
async def show_logical_server(
    ...
    LogicalServerReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-logical-server"
    data_obj = {"body": data}
