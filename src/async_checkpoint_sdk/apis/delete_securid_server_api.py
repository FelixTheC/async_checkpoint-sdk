...
async def delete_securid_server(
    ...
    ApiOkReply
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-securid-server"
    data_obj = {"body": data}
