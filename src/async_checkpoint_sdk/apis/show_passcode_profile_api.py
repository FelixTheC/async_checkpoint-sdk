...
async def show_passcode_profile(
    ...
    PasscodeProfileReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-passcode-profile"
    data_obj = {"body": data}
