...
async def show_data_type_keywords(
    ...
    KeyWordsDataTypeReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-data-type-keywords"
    data_obj = {"body": data}
