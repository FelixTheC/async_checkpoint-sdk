...
from async_checkpoint_sdk.models.connect_session_request import ConnectSessionRequest
from src.async_checkpoint_sdk.sdk_config import SDKConfig


async def connect_session(
    client: ClientSession, data: ConnectSessionRequest, config: SDKConfig, **kwargs
) -> ApiOkReply:
    """
    Parameters
    ----------
