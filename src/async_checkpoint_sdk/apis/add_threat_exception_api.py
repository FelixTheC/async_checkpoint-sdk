...
from async_checkpoint_sdk.models.threat_exception_request_new import ThreatExceptionRequestNew
from src.async_checkpoint_sdk.sdk_config import SDKConfig


async def add_threat_exception(
    client: ClientSession, data: ThreatExceptionRequestNew, config: SDKConfig, **kwargs
    ...
    data : ThreatExceptionRequestNew
    config : SDKConfig
    kwargs : Any
        Keyword arguments
