...
async def show_data_type_compound_group(
    client: ClientSession, data: ApiVisualCPObjectIdentifierRequestShow, config: Config, **kwargs
) -> CompoundGroupReply:
    """
    Retrieve existing Compound Data Type Group object using object name or uid.
    ...
    CompoundGroupReply
    """
    url = f"https://{config.server}:{config.port}/web_api/show-data-type-compound-group"
    data_obj = {"body": data}
