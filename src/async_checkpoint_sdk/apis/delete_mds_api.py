...
async def delete_mds(
    client: ClientSession, data: ApiVisualCPObjectIdentifierRequestDelete, config: SDKConfig, **kwargs
) -> ApiOkReply:
    """
    Delete existing object of type Multi-Domain Server or Multi-Domain Log Server using object name or uid.
    ...
    """
    url = f"https://{config.server}:{config.port}/web_api/delete-mds"
    data_obj = {"body": data}
