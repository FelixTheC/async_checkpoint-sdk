...
class DataLeakPreventionRequestEdit(BaseModel):
    open_extension_with_external_app: Add | Remove | str | list[str] = Field(
    ...
    share_protected_extension: Add | Remove | str | list[str] = Field(
        alias="share-protected-extension",
        description="""Share protected files extensions to external apps.""",
    )
    share_unprotected_extension: Add | Remove | str | list[str] = Field(
    ...
    accept_protected_file_extensions: Add | Remove | str | list[str] = Field(
    ...
    accept_unprotected_file_extensions: Add | Remove | str | list[str] = Field(
