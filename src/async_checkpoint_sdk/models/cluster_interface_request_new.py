...
class ClusterInterfaceRequestNew(BaseModel):
    name: str = Field(alias="name", description="""Object name. Must be unique in the domain.""")
    interface_type: str = Field(alias="interface-type", description="""Cluster interface type.""")
    ...
    multicast_address: str = Field(
        alias="multicast-address", description="""Multicast IP Address."""
    )
    multicast_address_type: str = Field(
        alias="multicast-address-type", description="""Multicast Address Type."""
    )
