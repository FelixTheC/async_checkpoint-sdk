from .authentication_settings_new import AuthenticationSettingsNew
from .identity_agent_portal_api_request import IdentityAgentPortalApiRequest
from .pydantic import BaseModel, Field


class IdentityAgentSettingsNew(BaseModel):
    ...
    authentication_settings: AuthenticationSettingsNew = Field(
