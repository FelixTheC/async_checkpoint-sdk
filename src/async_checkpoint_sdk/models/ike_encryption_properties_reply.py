...
class IkeEncryptionPropertiesReply(BaseModel):
    support_encryption_algorithms: IkeSupportEncryptionAlgsReply = Field(
    ...
    support_data_integrity: IkeSupportDataIntegrityReply = Field(
    ...
    support_diffie_hellman_groups: SupportDHGroupsReply = Field(
        alias="support-diffie-hellman-groups",
        description="""Select the Diffie-Hellman groups that will be supported with remote hosts.<br>Valid values: Group 1, Group 2, Group 5, Group 14.""",
    )
