...
class GroupReply(BaseModel):
    ...
    ranges: IpRanges = Field(
        alias="ranges",
        description="""Displays the group's matched content as ranges of IP addresses, in case 'show-as-ranges' is set to true.<br />In this case, the 'members' parameter is omitted.""",
    )
    color: str = Field(
