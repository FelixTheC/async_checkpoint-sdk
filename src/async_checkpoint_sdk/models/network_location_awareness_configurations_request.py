...
class NetworkLocationAwarenessConfigurationsRequest(BaseModel):
    ...
    network_or_group_of_conn_vpn_client: str = Field(
    ...
    excluded_internal_wireless_networks: Add | Remove | str | list[str] = Field(
    ...
    dns_suffixes: Add | Remove | str | list[str] = Field(
        alias="dns-suffixes",
