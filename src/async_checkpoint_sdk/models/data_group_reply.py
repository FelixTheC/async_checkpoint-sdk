...
class DataGroupReply(BaseModel):
...
For custom-made data types, you can use this field to provide more details.""",
    ...
    file_type: list[dict] = Field(
        alias="file-type", description="""List of data-types-file-attributes objects."""
    )
    file_content: list[dict] = Field(
        alias="file-content",
        description="""At least one content type must be matched. You can select Any.""",
    )
    color: str = Field(
