...
class LsmClusterProfileReply(BaseModel):
    ...
    cluster_interfaces: list[dict] = Field(alias="cluster-interfaces", description="""N/A""")
    cluster_members: list[dict] = Field(alias="cluster-members", description="""N/A""")
    ...
    interfaces: list[str] = Field(alias="interfaces", description="""Cluster network interfaces.""")
