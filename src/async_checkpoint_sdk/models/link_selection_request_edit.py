from .probing_settings_request_edit import ProbingSettingsRequestEdit
from .pydantic import BaseModel, Field


class LinkSelectionRequestEdit(BaseModel):
    ...
    probing_settings: ProbingSettingsRequestEdit = Field(
