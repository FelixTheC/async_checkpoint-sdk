...
class GatewayServerPolicyReply(BaseModel):
    access_policy_installation_date: ApiDateReply = Field(
        alias="access-policy-installation-date", description="""Access policy installation date."""
    )
    access_policy_installed: bool = Field(
        alias="access-policy-installed", description="""Gets true if access-policy was installed."""
    )
    ...
    access_policy_revision: ApiObjectStandardIdentifier = Field(
        alias="access-policy-revision", description="""Revision of the installed access policy."""
    )
    ...
    threat_policy_installation_date: ApiDateReply = Field(
        alias="threat-policy-installation-date", description="""Threat policy installation date."""
    )
    threat_policy_installed: bool = Field(
        alias="threat-policy-installed", description="""Gets true if threat-policy was installed."""
    )
    ...
    threat_policy_revision: ApiObjectStandardIdentifier = Field(
        alias="threat-policy-revision", description="""Revision of the installed threat policy."""
    )
