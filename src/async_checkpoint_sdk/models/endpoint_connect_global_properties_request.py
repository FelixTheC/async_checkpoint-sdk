from network_location_awareness_configurations_request import (
    NetworkLocationAwarenessConfigurationsRequest,
)
from pydantic import BaseModel, Field


class EndpointConnectGlobalPropertiesRequest(BaseModel):
    ...
    network_location_awareness_conf: NetworkLocationAwarenessConfigurationsRequest = Field(
