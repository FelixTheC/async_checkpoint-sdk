...
from secu_remote_dns_domain_request_new import SecuRemoteDnsDomainRequestNew


class SecuRemoteDnsRequestNew(BaseModel):
...
Identified by name or UID.""",
    ...
    domains: SecuRemoteDnsDomainRequestNew | list[dict] = Field(
        alias="domains", description="""The DNS domains that the remote clients can access."""
    )
