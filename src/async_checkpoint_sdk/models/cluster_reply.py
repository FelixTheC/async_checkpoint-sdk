...
class ClusterReply(BaseModel):
    ...
    cluster_members: list[dict] = Field(alias="cluster-members", description="""Cluster members.""")
    cluster_mode: str = Field(alias="cluster-mode", description="""Cluster mode.""")
    cluster_settings: AdvancedClusterSettingsReply = Field(
        alias="cluster-settings", description="""ClusterXL and VRRP Settings."""
    )
    cluster_xl: bool = Field(alias="cluster-xl", description="""Cluster XL blade enabled.""")
    ...
    ips_settings: IpsSettingsClusterReply = Field(
        alias="ips-settings", description="""IPS settings."""
    )
    ...
    logs_settings: LogsSettingsReply = Field(alias="logs-settings", description="""N/A""")
    mobile_access: bool = Field(
        alias="mobile-access", description="""Mobile-Access blade enabled."""
    )
    monitoring: bool = Field(alias="monitoring", description="""Monitoring blade enabled.""")
    ...
    proxy_settings: ProxySettingsReply = Field(alias="proxy-settings", description="""N/A""")
