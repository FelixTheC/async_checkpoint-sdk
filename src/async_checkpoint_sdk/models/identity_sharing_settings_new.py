from identity_cache_mode_duration_settings_request import IdentityCacheModeDurationSettingsRequest
from identity_cache_mode_settings_request import IdentityCacheModeSettingsRequest
from pydantic import BaseModel, Field


class IdentitySharingSettingsNew(BaseModel):
    ...
    receive_from: str | list[str] = Field(
