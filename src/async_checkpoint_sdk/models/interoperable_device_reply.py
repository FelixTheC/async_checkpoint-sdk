...
class InteroperableDeviceReply(BaseModel):
    ...
    ipv4_address: str = Field(
        alias="ipv4-address", description="""IPv4 address of the Interoperable Device."""
    )
    ipv6_address: str = Field(
        alias="ipv6-address", description="""IPv6 address of the Interoperable Device."""
    )
    ...
    vpn_settings: VpnSettingsReply = Field(
        alias="vpn-settings", description="""VPN domain properties for the Interoperable Device."""
    )
