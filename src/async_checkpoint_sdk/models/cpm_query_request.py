...
class CpmQueryRequest(BaseModel):
    facet: list[dict] = Field(alias="facet", description="""N/A""")
    filter: list[dict] = Field(alias="filter", description="""N/A""")
    ...
    query_id: str = Field(alias="query-id", description="""N/A""")
    query_params: ObjectNode = Field(alias="query-params", description="""N/A""")
