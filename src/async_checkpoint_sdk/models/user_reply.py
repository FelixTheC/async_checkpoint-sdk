...
class UserReply(BaseModel):
    ...
    connect_daily: bool = Field(alias="connect-daily", description="""Connect every day.""")
    ...
    certificates: list[dict] = Field(alias="certificates", description="""User certificates.""")
    encryption: UserEncryptionReply = Field(alias="encryption", description="""User encryption.""")
    color: str = Field(
        alias="color",
