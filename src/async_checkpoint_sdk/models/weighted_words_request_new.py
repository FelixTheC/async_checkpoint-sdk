from keywords_and_phrases_request import KeywordsAndPhrasesRequest
from pydantic import BaseModel, Field


class WeightedWordsRequestNew(BaseModel):
    name: str = Field(alias="name", description="""Object name. Must be unique in the domain.""")
    weighted_keywords: KeywordsAndPhrasesRequest | list[dict] = Field(
