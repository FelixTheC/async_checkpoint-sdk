...
class GenericObjectQueryRequest(BaseModel):
    class_name: str = Field(alias="class-name", description="""N/A""")
    filter: str = Field(
        alias="filter",
    ...
    uids: list[str] = Field(alias="uids", description="""N/A""")
    validate_all_found: bool = Field(alias="validate-all-found", description="""N/A""")
