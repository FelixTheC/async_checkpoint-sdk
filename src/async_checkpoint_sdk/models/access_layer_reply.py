...
class AccessLayerReply(BaseModel):
    ...
    firewall: bool = Field(
        alias="firewall", description="""Whether Firewall blade is enabled on this layer."""
    )
    ...
    parent_layer: str = Field(alias="parent-layer", description="""Parent layer of this layer.""")
