...
class WildcardRequestEdit(BaseModel):
    uid: str = Field(alias="uid", description="""Object unique identifier.""")
    ipv4_address: str = Field(alias="ipv4-address", description="""IPv4 address.""")
    ipv4_mask_wildcard: str = Field(
        alias="ipv4-mask-wildcard", description="""IPv4 mask wildcard."""
    )
    ipv6_address: str = Field(alias="ipv6-address", description="""IPv6 address.""")
    ipv6_mask_wildcard: str = Field(
        alias="ipv6-mask-wildcard", description="""IPv6 mask wildcard."""
    )
