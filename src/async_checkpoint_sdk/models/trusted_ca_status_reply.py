...
class TrustedCaStatusReply(BaseModel):
    ...
    latest_version: str = Field(alias="latest-version", description="""Latest available version.""")
    ...
    update_available: bool = Field(alias="update-available", description="""Is update available.""")
