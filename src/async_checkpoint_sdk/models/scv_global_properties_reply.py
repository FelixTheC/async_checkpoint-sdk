...
class ScvGlobalPropertiesReply(BaseModel):
    ...
    exceptions: list[dict] = Field(
        alias="exceptions",
        description="""The hosts that can be accessed using the selected services even if the client is not verified.<br>Available only if apply-scv-on-simplified-mode-fw-policies is true.""",
    )
