...
class GatewayCapabilitiesReply(BaseModel):
    restrictions: Restrictions = Field(alias="restrictions", description="""Set of restrictions.""")
    supported_blades: SupportedBlades = Field(
        alias="supported-blades", description="""Supported blades according to restrictions."""
    )
    ...
    supported_hardware: SupportedHardware = Field(
        alias="supported-hardware", description="""Supported hardware according to restrictions."""
    )
    ...
    supported_versions: SupportedVersions = Field(
        alias="supported-versions", description="""Supported versions according to restrictions."""
    )
