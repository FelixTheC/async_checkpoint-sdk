...
class TrustedCaCertificateReply(BaseModel):
    name: str = Field(alias="name", description="""Trusted CA certificate name.""")
    uid: str = Field(alias="uid", description="""Object unique identifier.""")
    type: str = Field(alias="type", description="""Object type.""")
    added_by: str = Field(alias="added-by", description="""By whom the certificate was added.""")
    base64_certificate: str = Field(
        alias="base64-certificate", description="""The certificate in base64."""
    )
    issued_by: str = Field(alias="issued-by", description="""Trusted CA certificate issued by.""")
    issued_to: str = Field(alias="issued-to", description="""Trusted CA certificate issued to.""")
    status: str = Field(
        alias="status",
