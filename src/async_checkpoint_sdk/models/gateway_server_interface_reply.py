...
class GatewayServerInterfaceReply(BaseModel):
    interface_name: str = Field(alias="interface-name", description="""Interface name.""")
    ...
    topology: GatewayServerInterfaceTopologyReply = Field(
        alias="topology", description="""Interface topology."""
    )
