...
class FirewallSettingsRequestEdit(BaseModel):
    ...
    connections_hash_size: int = Field(alias="connections-hash-size", description="""N/A""")
    maximum_limit_for_concurrent_connections: int = Field(
        alias="maximum-limit-for-concurrent-connections", description="""N/A"""
    )
    maximum_memory_pool_size: int = Field(alias="maximum-memory-pool-size", description="""N/A""")
