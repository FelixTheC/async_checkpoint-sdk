...
from .vpt_interface_vti_settings_request import VptInterfaceVtiSettingsRequest


class VptAddVdInterfaceRequest(BaseModel):
    ...
    vti_settings: VptInterfaceVtiSettingsRequest = Field(
        alias="vti-settings",
